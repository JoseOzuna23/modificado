...
public class TipoSolicitudesService {
    ...
    public SecuredResponse newAction(@Valid @RequestBody TipoSolicitudesRequest tipoSolicitudesRequest) throws Exception {
        ...
        if (Util.isNullOrEmpty(tipoSolicitudesRequest.getId()) || tipoSolicitudesRequest.getId() == 0) {
            // INSERT
